...
import net.pawlrip.gui.StSClientScreen;
import net.pawlrip.gui.cottonguis.PortusGui;
...
public class StSClientNetwork {
    ...
    public static final boolean PORTUS_SCREEN = ClientPlayNetworking.registerGlobalReceiver(
            StSMain.id("portus_screen"), ((client, handler, buf, responseSender) -> {
                client.execute(() -> MinecraftClient.getInstance().setScreen(new StSClientScreen(new PortusGui(client.player))));
            }));
