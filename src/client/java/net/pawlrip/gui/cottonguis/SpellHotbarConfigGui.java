package net.pawlrip.gui.cottonguis;
...
import net.pawlrip.cardinal_component.ClientPlayerMagicComponent;
import net.pawlrip.gui.cottonwidgets.WGridListPanel;
import net.pawlrip.gui.cottonwidgets.WSpellIconButton;
