...
import net.pawlrip.cardinal_component.player_magic_comp.PlayerMagicComponent;
 ...
 * see {@link net.pawlrip.mixin.client.ComponentsMixin} for more.
 *
 ...
 * </ul>
 *
 * @see net.pawlrip.mixin.client.ComponentsMixin
 * @see Components
 * @see PlayerMagicComponent
 * @see net.pawlrip.cardinal_component.player_magic_comp.ServerPlayerMagicComponent
 */
