 ...
 *      <li>The reload changes are applied ({@link net.pawlrip.mixin.PlayerManagerMixin#afterPlayerDataSave(CallbackInfo)})</li>
 ...
 * </ol>
 * @see net.pawlrip.StSEventListeners
 */
