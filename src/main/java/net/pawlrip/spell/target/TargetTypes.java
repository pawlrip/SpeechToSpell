...
import net.pawlrip.spell.target.targets.block.AnyBlockTarget;
import net.pawlrip.spell.target.targets.block.NoAirBlockTarget;
import net.pawlrip.spell.target.targets.entity.*;
