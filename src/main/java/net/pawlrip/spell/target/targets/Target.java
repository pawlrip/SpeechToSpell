package net.pawlrip.spell.target.targets;
 ...
 * which {@link net.pawlrip.spell.spells.Spell}s may make configurable.
 ...
 * <p><b>This is not to be confused with {@link net.pawlrip.spell.target.areas.TargetArea}.</b>
 * @see TargetTypes
 */
