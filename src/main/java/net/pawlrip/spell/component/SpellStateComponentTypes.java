package net.pawlrip.spell.component;
...
import net.pawlrip.codecs.ErrorSkippingDispatchedMapCodec;
 ...
 * and spell-specific data inside {@link net.pawlrip.spell.SpellState}s.
 */
public class SpellStateComponentTypes {
     ...
     * for tracking more customizable data in a {@link net.pawlrip.spell.SpellState}.
