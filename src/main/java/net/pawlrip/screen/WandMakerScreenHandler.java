...
import net.pawlrip.block.entity.WandMakerBlockEntity;
...
public class WandMakerScreenHandler extends SyncedGuiDescription {
    ...
    public WandMakerScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context, PropertyDelegate delegate) {
        ...
        // WOOD_SLOT
        WLabel woodLabel = new WLabel(Text.translatable("Wood"));
        ...
        // CORE_SLOT
        WLabel coreLabel = new WLabel(Text.translatable("Core"));
    ...
    public float getCraftingProgress() {
        ...
        float craftingTime = (float) this.propertyDelegate.get(WandMakerBlockEntity.PROPERTYDELEGATE_CRAFTING_TIME_INDEX);
        float craftingTimeTotal = (float) this.propertyDelegate.get(WandMakerBlockEntity.PROPERTYDELEGATE_CRAFTING_TIME_TOTAL_INDEX);
