package net.pawlrip.spell_school;
...
import net.pawlrip.StSEventListeners;
import net.pawlrip.StSMain;
import net.pawlrip.codecs.OptionalFieldCodec;
...
public class SpellSchoolManager extends MergingJsonDataLoader implements IdentifiableResourceReloadListener {
     ...
     * @see net.pawlrip.cardinal_component.player_magic_comp.ServerPlayerMagicComponent#onDataPacksReloaded()
     */
     ...
     * @see net.pawlrip.mixin.PlayerManagerMixin
     */
